      ...
      <article>
        ...
        <form action="process.php?mode=modify" method = "post">
          ...
          <div class="form-group">
              ...
              <textarea type="text" class="form-control" name="author" id="form-author" placeholder="작성자를 적어주세요."><?=$row['name']?></textarea>
          </div>

          <div class="form-group">
              <label for="form-content">내용</label>
              <textarea class="form-control" rows="10" name="content" id="form-content" placeholder="내용을 적어주세요."><?=$row['content']?></textarea>
          </div>
